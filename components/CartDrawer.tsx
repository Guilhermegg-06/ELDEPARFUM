            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {localItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  <p className="text-[#292828] font-medium mb-2">Carrinho vazio</p>
                  <p className="text-[#292828] text-sm mb-4">
                    Adicione produtos para começar suas compras.
                  </p>
                  <Link
                    href="/catalogo"
                    onClick={onClose}
                    className="text-[#292828] font-medium hover:underline"
                  >
                    Ir ao catálogo
                  </Link>
                </div>
                ...
                localItems.map((item) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-[#292828] mb-2">{item.ml}ml</p>
